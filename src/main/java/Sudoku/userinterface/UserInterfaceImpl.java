...
import Sudoku.SudokuDomain.Coordinates;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    // keep track of text fields for numbers
    ...
    public UserInterfaceImpl(Stage stage, Stage root) {
        this.stage = stage;
        this.root = new Group();
    ...
    @Override
    public void setListener(IUserInterfaceContract.EventListener lister) {
